...
namespace GetHandle.View
{
    public partial class GetHandleForm : Form
    {
        ...
        private void HandleButtonClickEvent(object sender, EventArgs e)
        {
            try
            {
                if (radioPosition.Checked)
                {
                    ...
                    this._windowProc = WindowProcFactoryMethod.getInstance().FindWindow(p);
                }
                else if (radioWindowClass.Checked)
                {
                    ...
                    this._windowProc = WindowProcFactoryMethod.getInstance().FindWindow(className, windowName);
                }
                else
                {
        ...
        private void OwnHandleButtonClickEvent(object sender, EventArgs e)
        {
            try
            {
                this._windowProc = WindowProcFactoryMethod.getInstance().GetControlWindow(this);
        ...
        private void TaskBarHandleButtonClickEvent(object sender, EventArgs e)
        {
            try
            {
                this._windowProc = WindowProcFactoryMethod.getInstance().GetTaskBarWindow();
